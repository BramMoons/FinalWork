...
class Database {
    ...
    private static String locatieMySqlServer = "jdbc:mysql://dt5.ehb.be:3306/1920brammoons";
    private static String gebruikersnaam = "1920brammoons";
    private static String wachtwoord = "Q9gTh6HH0w";
